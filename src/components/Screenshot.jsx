...
export default function Screenshot() {
  return (
    <div className="relative hidden px-8 sm:flex sm:items-center sm:justify-center">
      <div className="border-1 z-10 flex justify-center border-[0.5px] border-solid border-stone-200/60 bg-white/20 shadow backdrop-blur-md dark:shadow-lg dark:shadow-stone-400/30 sm:rounded-[32px] sm:p-5 md:rounded-[40px] md:p-7">
        <img
