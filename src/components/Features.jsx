...
export default function Features() {
  return (
    <Container className="mt-10 flex flex-col items-center sm:mt-20">
      ...
      <h3 className="mt-0 max-w-xs text-center font-display text-lg font-medium text-stone-800 dark:text-stone-100 sm:mt-2 sm:max-w-none sm:text-xl">
        Seamless is a cloud-native solution built on AWS
      </h3>
      <div className="mt-1 flex flex-col items-center sm:mt-4">
        {/* Main Card */}
        <div className="relative">
          <div className="absolute top-3 left-4 max-w-[250px] sm:top-4 sm:left-5">
          ...
          <img
            ...
            className="block min-h-[290px] w-[290px] max-w-[1000px] rounded-3xl object-cover object-right shadow-xl dark:shadow-lg dark:shadow-indigo-600/30 sm:w-full"
          />
        </div>
        {/* Cards */}
        <div className="mt-0 grid w-full max-w-[1000px] grid-cols-1 gap-x-6 sm:grid-cols-3 lg:mt-6 lg:gap-x-12">
          <div className="relative mt-6 max-w-[290px]">
            <div className="absolute top-3 left-4 max-w-[210px] sm:top-4 sm:left-5">
            ...
            <img
              ...
              className="block w-full rounded-3xl border-2 border-solid border-[#0091E2] shadow-xl dark:shadow-lg dark:shadow-sky-400/30"
            />
          </div>
          <div className="relative mt-6 max-w-[290px]">
            <div className="absolute top-3 left-4 max-w-[210px] sm:top-4 sm:left-5">
            ...
            <img
              ...
              className="block w-full rounded-3xl shadow-xl dark:shadow-lg dark:shadow-indigo-600/30"
            />
          </div>
          <div className="relative mt-6 max-w-[290px]">
            <div className="absolute top-3 left-4 max-w-[210px] sm:top-4 sm:left-5">
            ...
            <img
              ...
              className="block w-full rounded-3xl border-2 border-solid border-slate-300 shadow-xl dark:shadow-lg dark:shadow-stone-400/30"
            />
          </div>
        </div>
      </div>
